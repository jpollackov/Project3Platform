...
struct DataEntryView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            .padding()
            .alert(isPresented: Binding<Bool>.constant(isAlertPresented || isPriceErrorPresented || isPhoneNumberErrorPresented)) {
                switch true {
                case isAlertPresented:
                    return Alert(
